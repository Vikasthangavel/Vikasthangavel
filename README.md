...
| 🌾 **Time2Farm** | Farm finance tracker with section-wise P&L + Gemini AI insights | `Python` `Gemini API` `SQL` | ![Beta](https://img.shields.io/badge/BETA-fbbf24?style=flat-square) |
