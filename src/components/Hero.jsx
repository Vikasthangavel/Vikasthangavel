...
export default function Hero() {
  ...
  return (
    <section id="hero" className="min-h-screen flex items-center relative overflow-hidden hero-mesh">
      ...
      <motion.div
        className="absolute top-[5%] left-[2%] w-[520px] h-[520px] rounded-full blur-[140px] hero-blob-1 z-0"
        style={{ background: "rgba(99,102,241,0.13)", x: disableHeavyFx ? 0 : blobX, y: disableHeavyFx ? 0 : blobY }}
      />
      <motion.div
        className="absolute bottom-[8%] right-[5%] w-[400px] h-[400px] rounded-full blur-[130px] hero-blob-2 z-0"
        style={{ background: "rgba(139,92,246,0.10)", x: disableHeavyFx ? 0 : blobX, y: disableHeavyFx ? 0 : blobY }}
      />
      <motion.div
        className="absolute top-[40%] right-[20%] w-[300px] h-[300px] rounded-full blur-[120px] z-0"
      ...
      <div className="max-w-7xl mx-auto px-6 w-full z-10 py-24">
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="flex flex-col">
            ...
            >
              {/* Open-to-work pill */}
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-emerald-500/25 bg-emerald-500/8 text-emerald-700 text-xs font-mono backdrop-blur-sm shadow-sm">
                <span className="relative flex h-1.5 w-1.5">
                  <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-500 opacity-75" />
                  <span className="relative inline-flex rounded-full h-1.5 w-1.5 bg-emerald-500" />
                </span>
                <span className="text-slate-500">~/vikas-t</span>
                <ChevronRight size={11} className="text-slate-400" />
                <span className="text-emerald-600 font-semibold">open-to-work</span>
              </div>
              {/* Degree badge */}
              <motion.div
                ...
                className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full border border-amber-500/30 bg-amber-50 text-amber-700 text-xs font-mono backdrop-blur-sm shadow-sm"
              >
            ...
            >
              <p className="text-slate-400 font-mono text-sm mb-3 tracking-widest">// hello world</p>
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-black leading-[0.92] tracking-tight mb-3">
                <span className="text-slate-900 block">I'm</span>
                <span
            ...
            >
              <div
                className="inline-flex items-center gap-2.5 px-4 py-2.5 rounded-xl font-mono text-sm border shadow-sm"
                style={{ background: "#f1f5ff", borderColor: "rgba(99,102,241,0.2)" }}
              >
                {/* traffic-light dots */}
                ...
                <span className="text-slate-700 min-w-[180px]">{typed}</span>
                <motion.span
                  className="w-0.5 h-4 bg-indigo-500 rounded-sm"
            ...
            <motion.p
              ...
              className="text-slate-600 text-base md:text-[17px] leading-relaxed mb-9 max-w-lg"
            >
              Building production-grade apps from{" "}
              <span className="text-indigo-600 font-semibold">idea to deployment</span>.{" "}
              Full-stack products with Python, React &amp; AI —
              focused on{" "}
              <span className="text-violet-600 font-semibold">real-world impact</span>.
            </motion.p>
            ...
            >
              ...
              <div>
                ...
                <p className="text-amber-600/70 text-xs font-mono mt-0.5">Available from July 2026 · Open to relocation</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <motion.div whileHover={{ scale: 1.04, y: -2 }} whileTap={{ scale: 0.97 }}>
                <a
                  ...
                  className="flex items-center gap-2.5 px-6 py-3 rounded-xl font-semibold text-sm border text-slate-700 hover:text-indigo-600 transition-all backdrop-blur-sm bg-white shadow-sm"
                  style={{ borderColor: "rgba(99,102,241,0.2)", background: "white" }}
                >
              ...
              <motion.div whileHover={{ scale: 1.04, y: -2 }} whileTap={{ scale: 0.97 }}>
                <Link
                  ...
                  className="flex items-center gap-2.5 px-6 py-3 rounded-xl font-semibold text-sm border text-slate-700 hover:text-indigo-600 transition-all backdrop-blur-sm cursor-pointer bg-white shadow-sm"
                  style={{ borderColor: "rgba(99,102,241,0.15)", background: "white" }}
                >
                  Let's Talk
                </Link>
              </motion.div>
            ...
            >
              <span className="text-[10px] font-mono text-slate-400 uppercase tracking-widest">Find me</span>
              <div className="w-6 h-px bg-slate-300" />
              {[
                { href: "https://github.com/Vikasthangavel/",         icon: <Github   size={17} />, hover: "hover:text-slate-900 hover:border-slate-300" },
                { href: "https://www.linkedin.com/in/vikasthangavel/", icon: <Linkedin size={17} />, hover: "hover:text-blue-600 hover:border-blue-300" },
                { href: "mailto:vikasthangavel@gmail.com",             icon: <Mail     size={17} />, hover: "hover:text-indigo-600 hover:border-indigo-300" },
              ].map((s, i) => (
                <motion.a
                  key={i} href={s.href} target="_blank" rel="noopener noreferrer"
                  initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }}
                  transition={{ delay: 1.1 + i * 0.1 }} whileHover={{ y: -3, scale: 1.12 }}
                  className={`p-2 rounded-lg text-slate-500 border border-slate-200 bg-white shadow-sm transition-all duration-300 ${s.hover}`}
                >
                  {s.icon}
                </motion.a>
              ))}
              ...
              {stats.map((st, i) => (
                ...
                >
                  ...
                  <div
                    ...
                    style={{ color: "#6366f1", textShadow: "0 0 18px rgba(99,102,241,0.3)" }}
                  >
                    <AnimatedCounter value={st.value} delay={1400 + i * 250} />
                  </div>
                  <div className="text-[11px] text-slate-500 font-mono tracking-wide group-hover:text-slate-700 transition-colors text-center">
                    {st.label}
                  </div>
                  {st.sub && (
                    <div className="text-[9px] text-slate-400 font-mono tracking-wide mt-0.5 text-center leading-tight">
                      {st.sub}
                    </div>
                  )}
                </motion.div>
      ...
      <Link to="about" smooth duration={500} offset={-70} className="cursor-pointer absolute bottom-8 left-1/2 -translate-x-1/2 z-10">
        ...
        >
          ...
          >
            <div className="w-1 h-2 bg-indigo-500/60 rounded-full" />
          </motion.div>
        </motion.div>
      </Link>
