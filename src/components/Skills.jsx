              ...
              {techSkills.map((skill, i) => (
                ...
                >
                  <div className="flex justify-between mb-1.5">
                    <span className="text-sm font-mono text-gray-300 group-hover/skill:text-green-300 transition-colors">{skill.name}</span>
                    <motion.span
                      initial={{ opacity: 0 }}
                  ...
                  <div className="h-2 bg-gray-800 rounded-full overflow-hidden group-hover/skill:bg-gray-700 transition-colors">
                    <motion.div
                      ...
                      className="h-full rounded-full bg-gradient-to-r from-green-500 to-rose-500 group-hover/skill:from-green-400 group-hover/skill:to-purple-500 transition-all relative"
                    >
